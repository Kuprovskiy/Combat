...
break;
case "devastate1":
include("./magic/devastate1.php");
break;
case "defence1":
include("./magic/defence1.php");
break;
case "lifethirst":
include("./magic/lifethirst.php");
break;
case "hidden":
...
case "lifethirst": $script_name="runmagic1"; $magic_name="ЖЖ6"; break;
...
case "defence1": $script_name="runmagic1"; $magic_name="Наложить Защиту от Оружия"; break;
case "devastate1": $script_name="runmagic1"; $magic_name="Наложить Сокрушение"; break;
