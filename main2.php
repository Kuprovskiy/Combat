...
$user['pass2']=md5(array2HStr(md5m($pass2)));
        ...
        $headers .= "From: legendarybk <support@lostcombats.com>\r\n";
        ...
        $aa='<html>
                ...
                <body>
                    Вами, с IP адреса - '.$ip.', был установлен второй пароль в игре lostcombats.com.<br>
...
<table width=100%><tr>
<td align=left><INPUT onclick="this.form.addit.value=1" TYPE=submit value="Дополнительные образы" onClick="location.href='main.php?edit=0.467837356797105';">
<INPUT TYPE=submit value="Стандартные образы" onClick="location.href='main.php?edit=0.467837356797105';"></td><td><h3>Выбрать образ персонажа "<?=$user['login']?>"</h3></td>
<td align=right><INPUT TYPE=button value="Подсказка" onClick="location.href='main.php?edit=0.467837356797105';"><INPUT TYPE=button value="Вернуться" onClick="location.href='main.php?edit=0.467837356797105';"></td></tr>
<tr></tr>
</table>
</form>
<center>
<? if (@$_POST["addit"]) {
  echo "Для установления одного из этих или любого другого дополнительного образа себе или клану свяжитесь с персонажем Эллегия.<br><br>";
...
<TABLE border = 0 cellpadding="0" cellspacing="0" style="padding:5px;">
    <?if($user['sex']){?>
    <tr>
        <td><a href="?edit=1&obraz=1"><img src="<?=IMGBASE?>/i/shadow/<?=$user['sex']?>/m1.gif"></a></td><td><a href="?edit=1&obraz=20"><img src="<?=IMGBASE?>/i/shadow/<?=$user['sex']?>/m20.gif"></a></td><td><a href="?edit=1&obraz=38"><img src="<?=IMGBASE?>/i/shadow/<?=$user['sex']?>/m38.gif"></a></td><td><a href="?edit=1&obraz=39"><img src="<?=IMGBASE?>/i/shadow/<?=$user['sex']?>/m39.gif"></a></td>
        <td><a href="?edit=1&obraz=47"><img src="<?=IMGBASE?>/i/shadow/<?=$user['sex']?>/m47.gif"></a></td><td><a href="?edit=1&obraz=52"><img src="<?=IMGBASE?>/i/shadow/<?=$user['sex']?>/m52.gif"></a></td><td><a href="?edit=1&obraz=53"><img src="<?=IMGBASE?>/i/shadow/<?=$user['sex']?>/m53.gif"></a></td>
    </tr>
    <tr>
...
if($user['room']==1) {
  echo echoroom(array(
  roomobject(203,42, "i/rooms/1_door.gif", "Комната Перехода",2,array(72,134)),
  ));
?>
<div id="gotohint"></div>
<div align="right" style="text-align:justify; width:100%; padding: 3px;"><small>Мой Бойцовский Клуб приветствует Вас, <B><? echo $user['login'];?></B>.<BR>
...
if($user['room']==2) {
  echo echoroom(array(
  roomobject(330,75, "i/rooms/2_rightdoor.gif", "Комната Новичков",1,array(44,66)),
  roomobject(145,75, "i/rooms/2_leftdoor.gif", "Зал воинов 2", 6,array(44,66))
  ));
?>
...
if($user['room']==6) {
  echo echoroom(array(
  roomobject(20,28, "i/rooms/6_door.gif", "Бойцовский Клуб",3, array(87,162)),
...
if($user['room']==3) {
  ...
  echo echoroom(array(                                      
  roomobject(182,5, "i/rooms/3_stairway.gif?1", $rooms[11],11,array(159,160)),
  roomobject(10,70, "i/rooms/3_buduar.gif?1", $rooms[19],19,array(77,138)),
  roomobject(100,63, "i/rooms/3_hall1.gif?1", $rooms[5],5,array(74,126)),
  roomobject(359,67, "i/rooms/3_hall2.gif?1", $rooms[6],6,array(66,132)),
  roomobject(433,75, "i/rooms/3_hall3.gif?1", $rooms[7],7,array(90,136)),
  roomobject(0,215, "i/rooms/3_dungeon.gif?1", $rooms[4],4,array(45,70)),
  roomobject(468,215, "i/rooms/3_square.gif?1", $rooms[20],20,array(45,70)),
  roomobject(156,13, "i/rooms/3_torch1.gif", '',0,array(45,70)),
  roomobject(317,23, "i/rooms/3_torch2.gif", '',0,array(45,70)),
  ),"",530,270);
?>
...
if($user['room']==5) {
  echo echoroom(array(
  roomobject(247,88, "i/rooms/5_door.gif", "Бойцовский Клуб",3,array(44,80))
  ), "5_bg.jpg");
?>
...
if($user['room']==7) {
  echo echoroom(array(
  roomobject(227,105, "i/rooms/7_door.gif", "Бойцовский Клуб",3,array(37,86))
  ), "7_bg.jpg");
?>
...
if($user['room']==19) {
  echo echoroom(array(
  roomobject(417,53, "i/rooms/19_door.gif", "Бойцовский Клуб",3,array(73,111))
  ), "19_bg.jpg");
?>
 <div align=left><small>Если вы пришли сюда не за завтраком, обедом или ужином, то может быть вы ошиблись этажом?</small></div>
<div id="gotohint"></div>
