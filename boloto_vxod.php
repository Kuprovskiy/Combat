...
<FORM action="city.php" method=GET>
  <center><INPUT class=input TYPE="button" value="Подсказка" onClick="window.open('help/secretlab.html', 'help', 'height=300,width=500,location=no,menubar=no,status=no,toolbar=no,scrollbars=yes')">
    <INPUT class=input TYPE=button value="Вернуться" onClick="location.href='main.php?edit=0.467837356797105';">
    <br />
    <a href = "http://ccombats.ru/i/sl/sl.gif" target="_blank">Карта Прохода</a></center>
</FORM>
          ...
          if ($chislo > 0) {
            while($row = mysql_fetch_array($data)) {
              ...
              if ($user['boloto_groups'] == 0) {
                ...
                echo"<input name='naw_id' type='hidden' value='$bf'>
