<?php
  ...
  if ($user['id'] == 99999) {
    if (isset($_GET['goto'])) {
      mysql_query("UPDATE `demianblack`.`caveparties` SET  `x` =  '$_GET[x]', `y` =  '$_GET[y]', `floor` =  '$_GET[floor]' WHERE `caveparties`.`user` = $user[id] LIMIT 1;");
  ...
  include 'cave_bots.php';
  //$bots=array(3=>11111, 4=>11112, 5=>11113, 6=>11114, 7=>11115, 8=>11116, 9=>11135, 10=>11133, 11=>11141, 12=>11142, 13=>11143, 14=>11144, 15=>11145, 16=>11146, 17=>11147, 18=>11148, 19=>11149, 20=>11150, 21=>11151, 22=>11152, 23=>19581, 24=>19586, 25=>19587, 26=>"19593", 27=>19910, 50=>3946);
  //$botnames=array(3=>"Обезьяноподобный", 4=>"Зеленоглазый", 5=>"Ящер", 6=>"Тварь Рогатая", 7=>"Зеброкот", 8=>"Головастик", 9=>"Страж подгорья", 10=>"Цверг", 11=>"Смотритель мглы", 12=>"Сторож мглы", 13=>"Рабочий мглы", 14=>"Литейщик", 15=>"Надзиратель глубин", 16=>"Офицер глубин", 17=>"Наххр", 18=>"Служитель глубин", 19=>"Рубка глубин", 20=>"Берсерк", 21=>"Слизь", 22=>"Зубастая слизь", 23=>"Сторож мглы", 24=>"Рабочий мглы", 25=>"Надзиратель глубин", 26=> "Литейщик", 27=>"Рабочий мглы", 50=>"Отморозок");
  
  $objects=array(
    5=>"Статуя трупожёра", 6=>"Истлевший скелет", 7=>"Камень", 8=>"Телепорт", 9=>"Портал Шута", 
    10=>"Портал Чернокнижника", 11=>"Портал Епископа", 12=>"Подозрительная трещина", 13=>"Сундук", 
    14=>"Сундук", 15=>"Водосток", 16=>"Кровать", 17=>"Сундук", 18=>"Сундук", 19=>"Фонтан лёгкой жизни", 
    20=>"Замаскированный обменник", 21=>"Баррикада", 22=>"Дверь", 23=>"Сундук", 24=>"Завал",
    25=>"Сундук", 26=>"Сундук", 27=>"Трон повелителя", 28=>"Лаборатория", 29=>"Вымпел", 30=>"Гобелен",  
    31=>"Наковальня Забытых Мастеров", 50=>"Сундучок отморозка", 51=>"Решётка", 
    52=>"Прорубь", 53=>"Спуск", 
    54=>"Телепорт", 55=>"Телепорт", 56=>"Фонтан Искаженной Природы", 57=>"Вход в Мастерскую", 
    58=>"Спуск на 2-ой этаж", 59=>"Спуск на 3-ий этаж", 60=>"Спуск на 4-ый этаж",
    61=>"Фонтан Зыбытых Мастеров", 62=>"Таинственные круги", 63=>"Таинственный круг", 
    64=>"Фонтан лёгкой жизни и Таинственный круг", 65=>"Статуя Буржик", 66=>"Статуя Liona", 67=>"Статуя Хрясь", 
    68=>"Факел", 69=>"Телепорт", 70=>"Телепорт", 71=>"Вход на этаж", 72=>"Наковальня",
    73=>"Выбоина", 74=>"Сундук", 75=>"Фонтан Снадобья Разума", 76=>"Котёл", 77=>"Тележка",
    78=>"Останки Вашего предшественника", 79=>"Камень", 80=>"Решетка", 81=>"Сундук", 82=>"Кровать",
    500=>"Пустой сундук", 501=>"Сундук", 502=>"Куча мусора", 503=>"Выход", 
    504=>"Статуя", 505=>"Фонтан Призрачной силы", 506=>"Камень Портала Чернокнижника",
    507=>"Алтарь", 508=>"Статуя", 509=>"Камень Портала Епископа",
    510=>"Баррикада", 511=>"Купель", 512=>"Фонтан Призрачного ума", 513=>"Фонтан Былых Побед",
    514=>"Камень Портала Шута", 515=>"Алтарь Единения", 516=>"Алтарь Жертвенного Очищения",
    520=>"Мерцающий ключ Nr.3", "601"=>"Телепорт на 1-й этаж", "602"=>"Телепорт на 2-й этаж",
    21241=>"Военный специалист", 21242=>"Бешеный прапор", 
  );
  ...
  $dialogs=array(
    ...
    21239=>"Военком", 21240=>"Сержант", 21970=>"Шпион", 21971=>"Вождь Бездны"
  );
  ...
  function itemtofloor($item, $foronetrip, $incave=0, $podzem=1, $from = 'shop', $small = 0) {
    ...
    //if ($user['id'] == 7) die("select name, img from $from where id='$item'");
  ...
  if (@$_GET["move"] && $_SESSION["movetime"]<time()) {
    ...
    } elseif ($user["id"]==99999) $_SESSION["movetime"]=time()+6;
    elseif ($user["room"]==61 && $user["id"]!=99999) $_SESSION["movetime"]=time()+5;
    elseif ($_SERVER["REMOTE_ADDR"]=="127.0.0.1") $_SESSION["movetime"]=time()-1;
    elseif ($user["id"]!=99999) $_SESSION["movetime"]=time()+10;
  }
  ...
  function drawmap($map1, $players, $x, $y, $direction) {
      ...
      while ($data[$i]) {
        ...
        if ($user['id'] == 99999) {
            if (isset($dialogs[$bots[$data[1]]]) && $bots[$data[1]] != 11111) {
                $ret.="<img title=\"$botname".($cnt>1?" ($cnt)":"")."\" ".($y==1 && $x==3?"onclick=\"speakattackmenu(event);\"":"")." width=\"".$imgdata[$x][$y]["wd"]."\" height=\"".$imgdata[$x][$y]["ht"]."\" src=\"/i/dungeon/mobs/$bot.gif\" style=\"position:absolute;left:".$imgdata[$x][$y]["x"][$bn]."px;top:".$imgdata[$x][$y]["y"]."px;".($x==3 && $y==1?"cursor:pointer;":"").($x==3?"z-index:".(99-($y*5)).";":"")."\">";
            } else {
    ...
    function drawobject($cell, $x, $y) {
      ...
      if (!isset($imgmap[$obj])) {
        ...
        $ret.="<img usemap=\"#" . $imgmap[$obj]['name'] . "\" border=\"0\" title=\"$objects[$obj]\" width=\"$wd\" height=\"$ht\" src=\"/i/dungeon/objects/$obj.gif?1\" style=\"position:absolute;left:{$left}px;top:{$top}px;".($x==3?"z-index:".(99-($y*5)).";":"")."\">";
        $ret.=$imgmap[$obj]['code'];
      }
      return $ret;      
    }
    ...
    function drawobject2($cell, $x, $y) {
      ...
      if (!isset($imgmap[$obj])) {
        $ret.="
        ".($y==1 && $x==3?"<a href=\"cave.php?useitem=1\">":"")." 
        <img border=\"0\" title=\"$objects[$obj]\" width=\"$wd\" height=\"$ht\" src=\"/i/dungeon/objects/$obj.gif?1\" style=\"position:absolute;left:{$left}px;top:{$top}px;".($x==3?"z-index:".(99-($y*5)-1).";":"")."\">
        ".($y==1 && $x==3?"</a>":"");
      } else {
        $ret.="<img usemap=\"#" . $imgmap[$obj]['name'] . "\" border=\"0\" title=\"$objects[$obj]\" width=\"$wd\" height=\"$ht\" src=\"/i/dungeon/objects/$obj.gif?1\" style=\"position:absolute;left:{$left}px;top:{$top}px;".($x==3?"z-index:".(99-($y*5)-1).";":"")."\">";
        $ret.=$imgmap[$obj]['code'];
      }
      return $ret;      
    }
    ...
    while ($i>=0) {
      ...
      if ($objInWall[1] == 'o' /*&& file_exists($base . "/rsw$i$objInWall[2].gif")*/) {
