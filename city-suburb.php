...
if ($user['room']==20) {
    ...
    buildset(20,"$z_bk",74,144,"Бойцовский клуб", "", "Бойцовский клуб \\n временно закрыт");
    buildset(20,"$z_bs",105,121,"Башня смерти", "", "Башня смерти \\n временно закрыта");
    buildset(2,"$z_shop",171,330,"Магазин");
    buildset(4,"$z_mas",154,19,"Ремонтная мастерская");
	buildset(2005,"$z_comm",175,394,"Вокзал");
    buildset(12,"$bank",180,461,"Банк");
...
-->
    ...
    <BR><br>
        ...
        ?>
         ...
         <b>Сейчас в клубе: <?=$onlineS+$onlineSVC+6?>.</b><BR>
         <span style="font-size: 0.8em">В Virt City: <?=$onlineSVC+6?>.</span><br>
         <span style="font-size: 0.8em">В Suburb Virt City: <?=$onlineS?>.</span><br><br>
